...
<div class="container text-center">
	...
	$sql = "SELECT shelter.shelter_name, animals.id_animals, animals.image, animals.name, animals.description, animals.hobbies, animals.available, animals.status, animals.age FROM shelter inner JOIN animals on fk_shelter = id_shelter WHERE animals.status = 'old';";
